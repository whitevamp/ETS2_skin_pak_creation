...
def create_truck_sii(paint_id: str, path: Path, model: str) -> None:
    ...
    # Define the content of the .sii file using SiiNunit format
    content = f"""SiiNunit
{{
accessory_paint_job_data: {base_name}
{{
@include "{paint_id}_shared.sui"     # Shared paint job attributes (price, name, etc.)
@include "{paint_id}_metallic.sui"  # Optional: Metallic paint properties
@include "{paint_id}_mask.sui"      # Optional: Paint mask properties
...
suitable_for[]: "l2h3_8x4.{model}.cabin" # Example for 8x4 chassis cabins
...
@include "{paint_id}_shared.sui"     # Shared paint job attributes
@include "{paint_id}_metallic.sui"  # Optional: Metallic paint properties
@include "{paint_id}_mask.sui"      # Optional: Paint mask properties
